...
print(
    '<html><body><link href='
    '"https://fonts.googleapis.com/css?family=Roboto+Mono:300,700" '
    'rel="stylesheet"><style type="text/css">body {background-color:#1C1C1C;'
    'color: #fff;font-family: "Roboto Mono", "Hack", "Inconsolata", monospace;'
    '}a{color:#00AAEE;}</style>',
)

print(f"[*] <strong>Updated at :</strong> {str(datetime.datetime.now())}<br>")
...
print(
    ...
    '<a href="http://ctrl-c.club/~0x00ctrl" target="_blank">~0x00ctrl</a>\'s '
    '<a href="http://ctrl-c.club/~0x00ctrl/social.html" target="_blank">'
    'social</a> page.<br/>',
)
print(
    '<a href="https://github.com/sadikkuzu/ctrl-c-club/blob/master/socials.py"'
    ' target="_blank">Developed</a> by'
    '<a href="http://ctrl-c.club/~sadikkuzu" target="_blank">~sadikkuzu</a>',
)
